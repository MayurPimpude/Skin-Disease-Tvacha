...
#login details
mydatabase = client['Patient_Registration']
mycollection = mydatabase['Patitent Details']
...
def DRegister():
    if request.method == 'POST':
        ...
        find = mycollection.find_one({'email':email})

        if(find!=None):
            return render_template('DRegister.html',message = 'Already Registrated !')
        else:
            mycollection.insert_one(data)
            #return render_template('registration.html',mes = 'Registration Successful')
...
def Plogin():
    if request.method == 'POST':
        ...
        find = mycollection.find_one({'email':username}) 

        if(find!=None):
            return render_template('Plogin.html',message = 'unsuccessful')
        else:
            return redirect('/Paitent')
...
def PRegister():
    if request.method == 'POST':
        ...
        if(find!=None):
            return render_template('Pregister.html',message = 'unsuccessful')
        else:
            mycollection.insert_one(data)
            return render_template('Pregister.html',message = 'success')
